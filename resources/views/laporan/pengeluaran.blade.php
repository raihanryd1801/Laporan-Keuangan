        ...
        <div
            ...
            <table style="width: 100%; min-width: 1000px; border-collapse: collapse; font-size: 13px;">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" style="text-align: center; padding: 20px; color: #7f8c8d;">Belum ada data
                                pengeluaran cash.</td>
                        </tr>
                    @endforelse
                </tbody>
                <tfoot>
                    <tr
                        ...
                        <td colspan="5" class="text-right" style="padding: 10px;">TOTAL CASH:</td>
        ...
        <div
            ...
            <table style="width: 100%; min-width: 1000px; border-collapse: collapse; font-size: 13px;">
                ...
                <tfoot>
                    <tr
                        style="background-color: #f1f2f6; font-weight: bold; border-top: 2px solid #333; border-bottom: 2px solid #333;">
                        <td colspan="5" class="text-right" style="padding: 10px;">TOTAL TRANSFER:</td>
                        <td class="text-right" style="padding: 10px; color: #e74c3c;">Rp
